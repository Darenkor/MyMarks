...
description: "Expert in building Telegram Mini Apps (TWA) - web apps that run inside Telegram with native-like experience. Covers the TON ecosystem, Telegram Web App API, payments, user authentication, and building viral Mini Apps. Use when designing, building, or improving Telegram Mini Apps."
risk: unknown
...
|-------|----------|----------|
| Not validating initData from Telegram | high | Validate initData server-side |
| TON Connect not working on mobile | high | Test on mobile devices |
| Mini App feels slow and janky | medium | Optimize performance |
| Custom buttons instead of MainButton | medium | Use MainButton properly |
